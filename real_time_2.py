...
RECORDING_TIME = int(input('[INPUT] Recording time = ')) # second  
...
if __name__ == '__main__':
    ...
    while True:
        ...
        frame = cv2.putText(frame, predicted_label, (10,260), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,0,0), 2, cv2.LINE_AA)    
